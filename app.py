...
with col1:
    st.image('C:/Users/heeyoung/Desktop/4/chatbot/langchain-ask-pdf-main/yc_star.png')
with col2:
    st.title('영천시 관광 챗봇')
st.markdown('')
...
def main() :
    ...
    pdf= "C:/Users/heeyoung/Desktop/4/chatbot/langchain-ask-pdf-main/Yeongcheon.pdf"
    ...
    if pdf is not None :
        ...
        with col3:
            st.image('C:/Users/heeyoung/Desktop/4/chatbot/langchain-ask-pdf-main/yc_chr.png', width = 90)
        with col4:
